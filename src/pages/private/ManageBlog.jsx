...
import { Link, NavLink, Outlet, createSearchParams, useLocation, useNavigate, useParams, useSearchParams } from 'react-router-dom'
                        ...
                        <tr>
                            <th scope="col" className="px-3 py-4">
                                <div className="flex items-center">
                                    <input onClick={() => {}} id="checkbox-all-search" type="checkbox" className="w-4 h-4 bg-gray-100 border-gray-300 rounded"/>
                            ...
                            <th title='Click to sort by name' onClick={() => {}} scope="col" className="px-6 py-4 flex justify-between items-center cursor-pointer">
                                <span>Title</span>
                            </th>
                            <th scope="col" className="px-6 py-4 truncate">
                                View
                        ...
                        {blogList?.map(item => (
                            <tr key={item._id} className="bg-white text-base border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td className="w-4 pl-3">
                                    <div className="flex items-center">
                                        <input onClick={() => {}}  id="checkbox-table-search-1" type="checkbox" className="w-4 h-4 border-gray-300 rounded focus:ring-0 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="checkbox-table-search-1" className="sr-only">checkbox</label>
                                    </div>
                                </td>
                                <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                    <img className="w-20 h-14 object-contain rounded-md" src={item.images} alt="Jese image"/>
                                </th>
                                ...
                                <td className='pr-3'>
                                    ...
                                    <Tippy className='text-main bg-gray-700' content={<span>Edit blog</span>}>
                                        <button onClick={() => {setCurrentBlog(item)}} className={'px-5 py-2 rounded-lg border-2 border-green-500 text-green-500 hover:bg-green-500 hover:text-white'}><i className="fa-solid fa-file-pen"></i></button>
                                    </Tippy>
                                    <Tippy className='text-main bg-gray-700' content={<span>Delete blog</span>}>
                                        <button onClick={() => { }} className={'px-5 py-2 rounded-lg border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white'}><i className="fa-regular fa-trash-can"></i></button>
                                    </Tippy>
                                    </div>
                                </td>
                            </tr>
