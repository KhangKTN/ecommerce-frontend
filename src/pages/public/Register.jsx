    ...
    return (
        <div className='w-screen h-screen bg-gradient-to-r from-indigo-400 to-cyan-400 flex flex-col justify-center gap-y-10'>
            <div className='text-center flex flex-col items-center -mt-16 gap-y-3'>
                <h2 className='text-4xl text-white font-bold tracking-tight'>Register an account</h2>
            </div>
                ...
                <div className='w-full max-w-md bg-white rounded-xl shadow-md p-6'>
                    ...
                    <div className='w-full md:w-full'>
                        <button
                            onClick={() => handleClick()}
                            className={
                                `w-full flex items-center justify-center gap-x-4 bg-blue-600 border border-gray-200 rounded-lg py-3 px-3 leading-tight bg-gradient-to-r  text-white font-semibold !hover:transition-all !hover:duration-500 ` +
                                (isLoading
                                    ? 'opacity-80 cursor-auto'
                                    : 'cursor-pointer hover:from-teal-400 hover:to-blue-500')
                            }
                        >
                            {isLoading && (
                                <div role='status'>
                                    <svg
                                        aria-hidden='true'
                                        className='size-6 text-white animate-spin dark:text-gray-600 fill-sky-500'
                                        viewBox='0 0 100 101'
                                        fill='none'
