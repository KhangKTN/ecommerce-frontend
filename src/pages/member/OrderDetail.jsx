        ...
        <div className='mt-5'>
            ...
            <div className='flex flex-col gap-y-5 bg-gray-50 p-5 rounded-md'>
                <div className='flex gap-x-5 items-center'>
                    ...
                    <span className={`px-3 py-1 font-semibold rounded text-white ${getColor(order?.status)}`}>
                        {order?.status}
                    </span>
                </div>
                ...
                <div className='flex gap-x-5 items-center'>
                    ...
                    {order?.dateOfPayment ? (
                        <span className={`px-3 py-1 rounded text-white bg-green-500`}>
                            Paid <span>on {moment(order?.dateOfPayment).format('DD-MM-yyyy hh:mm')}</span>
                        </span>
                    ) : (
                ...
                <div className='mt-5'>
                    <FormComment
                        ...
                        data={{
                            ...
                            variant: productComment?.variant,
                            variantId: productComment?.variantId,
                            orderId: id
                        }}
                    />
                </div>
