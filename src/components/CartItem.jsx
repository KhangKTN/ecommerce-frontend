...
const CartItem = ({index, cartItem, handleChangeQuantity}) => {
        ...
        <div className='flex items-center gap-x-3 border-b-[1px] py-2'>
            ...
            <div className='min-w-[20%]'>
                <div className='flex mb-3'>
                    <button onClick={() => handleChangeQuantity({ index, value: '-', _id: cartItem._id })} className='h-10 px-3 bg-main font-bold text-lg rounded-s-md hover:text-white'>
                        <i className="fa-solid fa-minus"></i>
                    </button>
                    <input onChange={(e) => handleChangeQuantity({ index, value: e.target.value, _id: cartItem._id })} value={cartItem?.quantity} className='w-[40px] h-10 box-border border-[rgb(91,188,255)] border-2 text-center focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none' type="number" />
                    <button onClick={() => handleChangeQuantity({ index, value: '+', _id: cartItem._id })} className='h-10 px-3 bg-main font-bold text-lg rounded-e-md hover:text-white'>
