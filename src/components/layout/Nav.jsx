...
const navNotActive =
    'text-gray-700 border-2 border-white hover:border-main hover:border-2 p-3 rounded-full transition-all duration-300'
                ...
                <div className='max-w-md w-[300px] mx-auto'>
                    ...
                    <div className='relative'>
                        ...
                        <input
                            ...
                            type='search'
                            id='default-search'
                            className='block w-full px-4 py-2 ps-10 text-sm focus:outline-none text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500'
