        ...
        <div className='flex items-center justify-between py-10 border-b-[1px] border-gray-300'>
            ...
            <div className='flex items-center'>
                <div className='text-center px-5'>
                    <h1 className='text-base font-bold'><i className="fa-solid fa-phone text-main"></i> (+1800) 000 8808</h1>
                    <h1 className='text-sm'>Mon-Sat 8:00 AM - 8:00 PM</h1>
                </div>
                <div className='text-center px-5 border-l-[2px]'>
                    <h1 className='text-base font-bold'><i className="fa-regular fa-envelope text-main"></i> SUPPORT@TADATHEMES.COM</h1>
