...
export const adminSidebar = [
    {
        ...
        iconClassName: 'fa-solid fa-gauge'
    },
    {
        id: 2,
        type: 'single',
    ...
    },
    {
        ...
        submenu: [
            { id: '41', text: 'Create product', path: `/${path.ADMIN}/${path.CREATE_PRODUCT}` },
            { id: '42', text: 'Manage product', path: `/${path.ADMIN}/${path.MANAGE_PRODUCT}` }
        ]
    },
    {
        id: 5,
        ...
        submenu: [
            { id: '51', text: 'Create blog', path: `/${path.ADMIN}/${path.CREATE_BLOG}` },
            { id: '52', text: 'Manage blog', path: `/${path.ADMIN}/${path.MANAGE_BLOG}` }
        ]
    }
]
...
export const memberNavLink = [
    {
        id: 1,
        text: 'Cart',
        path: `/${path.ACCOUNT}/${path.CART}`,
        icon: <i className='fa-solid fa-cart-shopping mr-3'></i>
    },
    {
        id: 2,
        text: 'Profile',
        path: `/${path.ACCOUNT}/${path.PROFILE}`,
        icon: <i className='fa-solid fa-circle-info mr-3'></i>
    },
    {
        id: 4,
        text: 'Orders',
        path: `/${path.ACCOUNT}/${path.ORDER}`,
        icon: <i className='fa-solid fa-list-ul mr-3'></i>
    },
    {
        id: 3,
        text: 'Security',
        path: `/${path.ACCOUNT}/${path.SECURITY}`,
        icon: <i className='fa-solid fa-shield mr-3'></i>
    }
]
...
export const paymentMethod = [
    {
        id: 'payment_1',
        value: 'cod',
        icon: 'https://cdn-icons-png.flaticon.com/512/2897/2897855.png',
        text: 'COD (Cash on delivery)',
        description: 'You will pay when you receive the product'
    },
    {
        id: 'payment_2',
        value: 'paypal',
        icon: 'https://static-00.iconduck.com/assets.00/paypal-icon-2048x547-tu0aql1a.png',
        text: 'Paypal',
        description: 'You will pay immediately after pressing the Order Now button through the Paypal service'
    },
    {
        id: 'payment_3',
        value: 'vnpay',
        ...
        text: 'VNPay',
        description: 'You will pay immediately after pressing the Order Now button through the VNPay service'
    }
]
